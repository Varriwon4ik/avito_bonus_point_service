...
| Integration tests | API + Postgres: accrual, batch accrual per-item results (US-01), balance, hold/confirm/cancel, debit, idempotency, FIFO-by-expiry, pagination, lots audit filters (US-02), error envelope, OpenAPI routes, metrics | `go test ./internal/api/... -race -p 1` | Passing | [integration_test.go](../internal/api/integration_test.go), [pagination_test.go](../internal/api/pagination_test.go), [lots_test.go](../internal/api/lots_test.go), [metrics_integration_test.go](../internal/api/metrics_integration_test.go) |
